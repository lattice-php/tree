...
export declare function findPath(rows: TreeRow[], rowId: string, prefix?: TreePath): TreePath | null;
...
export declare function canPlace(rows: TreeRow[], sourceRowId: string, parentRowId: string | null, options: {
 ...
 */
export declare function moveNode(rows: TreeRow[], sourceRowId: string, parentRowId: string | null, index: number): TreeRow[];
